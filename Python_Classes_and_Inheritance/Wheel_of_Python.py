"""
Wheel of Python - A simplified version of the game Wheel of Forturne.
"""
...
class WOFPlayer:
    """
    This class represents the wheel of fortune player.
    It has 3 instance variables,
    .name - Name of the player
    .prizeMoney - AMount of prize money for this player
    .prizes - Prizes, this player has won so far
    """
...
class WOFHumanPlayer(WOFPlayer):
    """
    This class represents human player and inherits from the class WOFPlayer.
    """
...
class WOFComputerPlayer(WOFPlayer):
    """
    This class represents the computer player and inherits from WOFPlayer.
    It has an additional class variable .SORTED_FREQUENCIES and an instance variable .difficulty, which 
    represents the level of difficulty for this computer.
    """
    ...
    def getMove(self,category, obscuredPhrase, guessed):
        ...
        if lst != []:
            if self.smartCoinFlip():
                HIGH = None
                for char in lst:
                    ind = WOFComputerPlayer.SORTED_FREQUENCIES.index(char)
                    if HIGH == None or ind > HIGH:
                        HIGH = ind
                return WOFComputerPlayer.SORTED_FREQUENCIES[HIGH]
            else:
